...
<div class="Table" style="width: 100%">
    <div class="Row" style="height: 200px">
        ...
        <div class="Cell">
            ...
            <input type="button" name="btnGetMapDealers" id="btnGetMapDealers" value="Find Nearby Dealer"
                   onclick="populateMap()"><br/>
            <br/>
...
<div class="row dealPreview" style="display:none">
    <ul>
        <li>
            <div>Dealer : <span id="DealerInfo"></span></div>
        </li>
        <li>
            <div>Sales Person :
...
<script type="text/javascript">
    ...
    function showDealPreview() {
        ...
        /*
         ...
         {
         url: "
        <?php echo Yii::app()->createUrl('ajax/getDealerParams'); ?>",
         data: {'dealerId': dealerId},
         dataType: "json",
         headers: {'Content-Type': 'application/json'}
         }).done(function ( result ) {

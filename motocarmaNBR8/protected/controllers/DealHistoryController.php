...
class DealHistoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['DealHistory']))
		{
			$model->attributes=$_POST['DealHistory'];
			if($model->save())
	...
	{
		$model=new DealHistory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DealHistory']))
			$model->attributes=$_GET['DealHistory'];
	...
	{
		$model=DealHistory::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DealHistory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='deal-history-form')
		{

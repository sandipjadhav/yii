...
<div class="Table">
    ...
    <div class="Heading">
        ...
        <div class="Cell col<?php echo $i; ?> compareCell">
            <a href="javascript:void(0)" onclick="removeGarageCar('<?php echo $carArray[$i]['id']; ?>'); removeColumn('<?php echo $i; ?>');">Remove</a>
            <p><?php echo $carArray[$i]['make']['name']?></p>
            <div style="width: 100%; height: 100%"><?php $photo = Yii::app()->customUtility->extractStylePhoto($carArray[$i]['id']); ?>
                <img src="<?php echo $photo ?>" style="width: 90%" align="left"/>
            </div>
        </div>
        <?php } ?>
    </div>
